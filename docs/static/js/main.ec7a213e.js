/*! For license information please see main.ec7a213e.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
        ...
        function $a(e) {
          ...
          function h(l, a, i, u) {
            ...
            if (h === i.length) return t(l, f), za && xa(l, h), s;
            if (null === f) {
              for (; h < i.length; h++)
                null !== (f = d(l, i[h], u)) &&
                  ((a = o(f, a, h)),
        ...
        function hi(e, n, t) {
          ...
          switch ((Ca(n), n.tag)) {
            ...
            case 4:
              return (
                Ga(), null === e && Ar(n.stateNode.containerInfo), mi(n), null
              );
            case 10:
              return ql(n.type._context), mi(n), null;
            case 19:
              if ((Sl(eo), null === (o = n.memoizedState))) return mi(n), null;
            ...
            case 23:
              return (
                ...
                r && 0 !== (1 & n.mode)
                  ? 0 !== (1073741824 & wu) &&
                    (mi(n), 6 & n.subtreeFlags && (n.flags |= 8192))
                  : mi(n),
                null
              );
            case 24:
        ...
        function Ei(e, n, t, r, l) {
          ...
          if ((Yl(n, l), null === n.stateNode))
            ...
            i !== f || d !== m || Cl.current || Jl
              ? ("function" === typeof p &&
                  (ua(n, t, p, r), (m = n.memoizedState)),
                (s = Jl || ca(n, t, s, r, d, m, u) || !1)
                  ? (c ||
        ...
        function rs() {
          var e = mu.current;
          return (mu.current = Jo), null === e ? Jo : e;
        }
        function ls() {
          (0 !== xu && 3 !== xu && 2 !== xu) || (xu = 4),
            null === yu ||
        ...
        function as(e, n) {
          ...
          if ((Wl(), (gu = t), (mu.current = r), null !== bu))
            throw Error(a(261));
        ...
        function ss(e) {
          ...
          do {
            ...
            if (((e = n.return), 0 === (32768 & n.flags))) {
              if (null !== (t = hi(t, n, wu))) return void (bu = t);
            } else {
              if (null !== (t = Ai(t, n)))
        ...
        if (!1 !== e.selectedElement)
          return (0, o.jsxs)("div", {
            ...
            children: [
              ...
              (0, o.jsx)("img", {
                src: e.selectedElement.cardLink,
                alt: "overlay img",
                className: "overlay__img",
              }),
              (0, o.jsx)("p", {
                className: "overlay__text",
                children: e.selectedElement.cardName,
              }),
            ],
          });
      }
      ...
      function m(n) {
        ...
        return (
          e.useEffect(function () {
            d.getUserInfo().then(function (e) {
              r(e._id), b(e.avatar), v(e.about), f(e.name);
            });
          }, []),
          e.useEffect(function () {
            d.getInitialCards().then(function (e) {
              var n = e.map(function (e) {
                return (0,
                o.jsx)(p, { cardLikes: e.likes, cardName: e.name, cardLink: e.link, handleCardClick: x }, e._id);
              });
              S([].concat(u(w), [n]));
            });
          }, []),
          (0, o.jsxs)("main", {
            children: [
              ...
              (0, o.jsx)("section", { className: "cards", children: w }),
              (0, o.jsxs)(s, {
                name: "formProfile",
                title: "Edit Profile",
                isOpen: n.isEditProfilePopupOpen,
                onClose: n.onClose,
                children: [
                  (0, o.jsx)("input", {
              ...
              (0, o.jsxs)(s, {
                ...
                isOpen: n.isEditAvatarPopupOpen,
                onClose: n.onClose,
                children: [
                  (0, o.jsx)("input", {
                    className: "textbox popup__input",
              ...
              (0, o.jsx)(c, {
                selectedElement: n.selectedElement,
                onClose: n.onClose,
              }),
              (0, o.jsx)(s, {
          ...
          return (0, o.jsxs)("div", {
            ...
            children: [
              ...
              (0, o.jsx)(m, {
                ...
                isEditProfilePopupOpen: t,
                isAddPlacePopupOpen: u,
                isEditAvatarPopupOpen: f,
              }),
              (0, o.jsx)(h, {}),
            ],
          });
...
//# sourceMappingURL=main.ec7a213e.js.map
